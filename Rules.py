...
def global_rules(world, player):
    ...
    set_rule(world.get_entrance('Sewers Door', player), lambda state: state.has_key('Small Key (Escape)', player) or (world.universal_keys[player] and world.mode[player] == 'standard')) # standard retro cannot access the shop
