...
def main():
    ...
    parser.add_argument('--extendedmsu', action='store_true', help='Use Extended MSU-1 tracks.')
...
def roll_settings(weights):
    ...
    universalkeys = get_choice('universal_keys') if 'universal_keys' in weights else 'off'
